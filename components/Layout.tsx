...
const Layout: React.FC<LayoutProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      {/* Top Bar - Verbergen als scanner open is voor maximale ruimte */}
      {!hideMobileNav && (
      ...
      {/* Mobile Nav - Dit is de boosdoener! Verberg deze als hideMobileNav true is */}
      {!hideMobileNav && (
      ...
      {!hideMobileNav && <div className="h-24 md:hidden" />}
    </div>
  );
};
